...
func OAuth(c *gin.Context) {
	...
	utils.SetAuthCookie(c, "oauth_state", state, 3600, http.SameSiteLaxMode)
...
func OAuthCallback(c *gin.Context) {
	...
	utils.SetAuthCookie(c, "oauth_state", "", -1, http.SameSiteLaxMode)
	...
	utils.SetAuthCookie(c, "binding_external_account", "", -1, http.SameSiteLaxMode)
	if uuid != "" {
		// 绑定外部账号
